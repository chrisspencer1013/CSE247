...
public class DijkstraAlgorithmSet {
	...
	public static void main(String[] args){
		...
		int nextNode = 0;//nextNode holds the value for the next node.
		...
		for(int i = 0; i < distance.length; i++){
			...
			preD[i] = 0; //to find the actual path
		...
		System.out.println("The shortest path from node 0 to all nodes are:");
		for(int i = 0; i < 5; i++){
